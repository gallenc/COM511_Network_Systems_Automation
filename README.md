...
[Sessions](../main/sessions) Contains the tutorial material for each class session.

This is where the tutorials and examples for each week will be created and updated as we go along.
PLEASE do not change material here as it will be updated and you will have difficulty merging any upstream changes with your own work.
Instead COPY each session's material into your own [myPracticeCourseWork](../main/myPracticeCourseWork) folder and modify it from there.

## Your Practice Coursework
...
This folder also contains some structured journal pages for you to record your work and keep screenshots etc.
